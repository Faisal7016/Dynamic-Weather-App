...
const api_key = `b0ab1f2bfc5542c8b82101836243107`;
...
function fetchWeatherData(){
    fetch(`https://api.weatherapi.com/v1/current.json?key=${api_key}&q=${cityInput}&aqi=no`)
    .then(response => response.json())
    .then(data => {
        console.log(data);
        temp.innerHTML = Math.floor(data.current.temp_c) + "&#176;";
        feels_like.innerHTML = Math.floor(data.current.feelslike_c) + "&#176;" + "C"
